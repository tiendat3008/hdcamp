package com.hdcamp.backend.auth.service;
...
import com.hdcamp.backend.auth.dto.SessionMetadata;
import com.hdcamp.backend.auth.dto.UserSessionResponse;
import com.hdcamp.backend.auth.entity.User;
import com.hdcamp.backend.auth.enums.Role;
import com.hdcamp.backend.auth.enums.UserStatus;
import com.hdcamp.backend.auth.repository.UserRepository;
...
import com.hdcamp.backend.common.security.JwtTokenProvider;
import com.hdcamp.backend.user.entity.UserProfile;
import com.hdcamp.backend.user.repository.UserProfileRepository;
